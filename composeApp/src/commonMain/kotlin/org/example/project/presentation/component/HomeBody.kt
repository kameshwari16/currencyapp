...
import org.example.project.util.DoubleConverter
import org.example.project.util.GetBebasFontFamily
import org.example.project.util.calculateExchangeRate
import org.example.project.util.convert
...
fun HomeBody(
    ...
    Column(
        modifier = Modifier
            ...
            .imePadding()//avoid components pushed up when we open
    ) {
        Column(
